import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.8c2da384.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"vue/vue3.md","filePath":"vue/vue3.md","lastUpdated":1708966819000}'),p={name:"vue/vue3.md"},o=l(`<h3 id="定义组件" tabindex="-1">定义组件 <a class="header-anchor" href="#定义组件" aria-label="Permalink to &quot;定义组件&quot;">​</a></h3><h4 id="definedcomponent" tabindex="-1">definedComponent <a class="header-anchor" href="#definedcomponent" aria-label="Permalink to &quot;definedComponent&quot;">​</a></h4><p>defineComponent 用于定义一个组件,允许接收一个组件 Option 的对象,或者是一个 setup 函数，函数名称将作为组件名称来使用。</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// vue2.x的写法:defineComponent接收options对象</span></span>
